...
function Calendar({
  ...
  const _monthsClassName = cn(
    "relative flex flex-col gap-4 sm:flex-row w-full",
  ...
  const _weekdaysClassName = cn("flex w-full justify-between", props.weekdaysClassName);
  ...
  const _weekClassName = cn("mt-2 flex w-full items-start justify-between", props.weekClassName);
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: hideNavigation ? "hidden" : "", // Only hide navigation if hideNavigation is true
        ...classNames,
      }}
      components={{
        Dropdown,
