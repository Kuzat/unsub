          ...
          <CardContent>
            <article className="prose prose-slate dark:prose-invert max-w-none space-y-6">
              ...
              <ul className="list-disc pl-6 space-y-3 my-4">
                <li>
                  <p className="text-base leading-relaxed">
                    <strong className="font-semibold">Account</strong> means a unique account created for You to access our Service
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Unsub, accessible from{" "}
                    <a
              ...
              <ul className="list-disc pl-6 space-y-2 my-4">
                <li>
                  <p className="text-base leading-relaxed">Email address</p>
                </li>
                <li>
                  <p className="text-base leading-relaxed">First name and last name</p>
                </li>
                <li>
                  <p className="text-base leading-relaxed">Usage Data</p>
                </li>
              </ul>

              <h4 className="text-xl font-medium mt-4 mb-2">Usage Data</h4>
              <p className="text-base leading-relaxed">Usage Data is collected automatically when using the Service.</p>
              ...
              <h4 className="text-xl font-medium mt-4 mb-2">Information from Third-Party Social Media Services</h4>
              <p className="text-base leading-relaxed">
              ...
              <ul className="list-disc pl-6 space-y-2 my-4">
                <li className="text-base leading-relaxed">Google</li>
              </ul>
              <p className="text-base leading-relaxed mt-3">
              ...
              <h4 className="text-xl font-medium mt-4 mb-2">Tracking Technologies and Cookies</h4>
              <p className="text-base leading-relaxed">
              ...
              <p className="text-base leading-relaxed">The Company may use Personal Data for the following purposes:</p>
              <ul>
                <li>
                  <p>
              ...
              <p className="text-base leading-relaxed mt-3">Our Service may give You the ability to delete certain information about You from within the
                Service.</p>
              <p className="text-base leading-relaxed mt-3">
              ...
              <h4 className="text-xl font-medium mt-4 mb-2">Business Transactions</h4>
              <p className="text-base leading-relaxed">
              ...
              <h4 className="text-xl font-medium mt-4 mb-2">Law enforcement</h4>
              <p className="text-base leading-relaxed">
              ...
              <h4 className="text-xl font-medium mt-4 mb-2">Other legal requirements</h4>
              <p className="text-base leading-relaxed">The Company may disclose Your Personal Data in the good faith belief that such action is necessary
                to:</p>
              <ul className="list-disc pl-6 space-y-2 my-4">
              ...
              <p className="text-base leading-relaxed">We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the
                new
              ...
              <p className="text-base leading-relaxed">If you have any questions about this Privacy Policy, You can contact us:</p>
              <ul className="list-disc pl-6 space-y-2 my-4">
                <li className="text-base leading-relaxed">By email: privacy@unsub.cash</li>
              </ul>
            </article>
          </CardContent>
        </Card>
