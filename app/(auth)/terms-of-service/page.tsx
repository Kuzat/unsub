...
export default async function TermsOfServicePage() {
  return (
    <div className="bg-muted flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10">
      <div className="flex w-full max-w-sm sm:max-w-5xl flex-col gap-6">
        <Card>
          <CardHeader>
            <CardTitle>Terms and Conditions</CardTitle>
            <CardDescription>Last updated: July&nbsp;01,&nbsp;2025</CardDescription>
          </CardHeader>
          <CardContent>
            <article className="prose prose-slate dark:prose-invert max-w-none space-y-6">
              <p className="text-base leading-relaxed">Please read these terms and conditions carefully before using Our Service.</p>
              ...
              <ul className="list-disc pl-6 space-y-3 my-4">
                <li>
                  <p className="text-base leading-relaxed">
                    <strong className="font-semibold">Affiliate</strong> means an entity that controls, is controlled by or is
                ...
                <li>
                  <p className="text-base leading-relaxed">
                    <strong className="font-semibold">Account</strong> means a unique account created for You to access our
                    Service or parts of our Service.
                  </p>
                </li>
                <li>
                  <p className="text-base leading-relaxed">
                    <strong className="font-semibold">Country</strong> refers to: Norway
                  </p>
                </li>
                <li>
                  <p className="text-base leading-relaxed">
                    <strong className="font-semibold">Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Unsub.
                  </p>
                </li>
                <li>
                  <p className="text-base leading-relaxed">
                    <strong className="font-semibold">Content</strong> refers to content such as text, images, or other information
                ...
                <li>
                  <p className="text-base leading-relaxed">
                    <strong className="font-semibold">Device</strong> means any device that can access the Service such as a
                    computer, a cellphone or a digital tablet.
                  </p>
                </li>
                <li>
                  <p className="text-base leading-relaxed">
                    <strong className="font-semibold">Feedback</strong> means feedback, innovations or suggestions sent by You
                    regarding the attributes, performance or features of our Service.
                  </p>
                </li>
                <li>
                  <p className="text-base leading-relaxed">
                    <strong className="font-semibold">Goods</strong> refer to the items offered for sale on the Service.
                  </p>
                </li>
                <li>
                  <p className="text-base leading-relaxed">
                    <strong className="font-semibold">Orders</strong> mean a request by You to purchase Goods from Us.
                  </p>
                </li>
                <li>
                  <p className="text-base leading-relaxed">
                ...
                <li>
                  <p className="text-base leading-relaxed">
                    <strong className="font-semibold">Terms and Conditions</strong> (also referred as &quot;Terms&quot;) mean these
                ...
                <li>
                  <p className="text-base leading-relaxed">
                    <strong className="font-semibold">Third-party Social Media Service</strong> means any services or content
                ...
                <li>
                  <p className="text-base leading-relaxed">
                    <strong className="font-semibold">Website</strong> refers to Unsub,&nbsp;
                    <a
                      href="https://unsub.cash"
                ...
                <li>
                  <p className="text-base leading-relaxed">
                    <strong className="font-semibold">You</strong> means the individual accessing or using the Service, or the
              ...
              <h2 className="text-3xl font-bold mt-8 mb-4">Placing Orders for Goods</h2>
              <p className="text-base leading-relaxed">
              ...
              <h3 className="text-2xl font-semibold mt-6 mb-3">Your Information</h3>
              <p className="text-base leading-relaxed">
              ...
              <h3 className="text-2xl font-semibold mt-6 mb-3">Order Cancellation</h3>
              <p className="text-base leading-relaxed">
                We reserve the right to refuse or cancel Your Order at any time for certain reasons
                including but not limited to:
              </p>
              <ul className="list-disc pl-6 space-y-2 my-4">
                <li className="text-base leading-relaxed">Goods availability</li>
                <li className="text-base leading-relaxed">Errors in the description or prices for Goods</li>
                <li className="text-base leading-relaxed">Errors in Your Order</li>
              </ul>
              <p className="text-base leading-relaxed">
              ...
              <h4 className="text-xl font-medium mt-4 mb-2">Your Order Cancellation Rights</h4>
              <p className="text-base leading-relaxed">
              ...
              <p className="text-base leading-relaxed">
                ...
                condition as You received them or which are worn simply beyond opening the original
                packaging will not be refunded. You should therefore take reasonable care of the
              ...
              <p className="text-base leading-relaxed">You will not have any right to cancel an Order for the supply of any of the following Goods:</p>
              <ul className="list-disc pl-6 space-y-2 my-4">
                <li className="text-base leading-relaxed">The supply of Goods made to Your specifications or clearly personalized.</li>
              ...
              <h3 className="text-2xl font-semibold mt-6 mb-3">Availability, Errors and Inaccuracies</h3>
              <p className="text-base leading-relaxed">
              ...
              <h3 className="text-2xl font-semibold mt-6 mb-3">Prices Policy</h3>
              <p className="text-base leading-relaxed">The Company reserves the right to revise its prices at any time prior to accepting an Order.</p>
              <p className="text-base leading-relaxed">
                ...
                matter beyond the control of the Company. In that event, You will have the right to
                cancel Your Order.
              </p>

              <h3 className="text-2xl font-semibold mt-6 mb-3">Payments</h3>
              <p className="text-base leading-relaxed">
              ...
              <h2 className="text-3xl font-bold mt-8 mb-4">Content</h2>

              <h3 className="text-2xl font-semibold mt-6 mb-3">Your Right to Post Content</h3>
              <p className="text-base leading-relaxed">
              ...
              <h3 className="text-2xl font-semibold mt-6 mb-3">Content Restrictions</h3>
              <p className="text-base leading-relaxed">
              ...
              <ul className="list-disc pl-6 space-y-2 my-4">
                <li className="text-base leading-relaxed">Unlawful or promoting unlawful activity.</li>
                <li className="text-base leading-relaxed">
                ...
                <li className="text-base leading-relaxed">Impersonating any person or entity including the Company and its employees or representatives.</li>
                <li className="text-base leading-relaxed">Violating the privacy of any third person.</li>
                <li className="text-base leading-relaxed">False information and features.</li>
              </ul>
              <p className="text-base leading-relaxed">
                ...
                use of the Service if You post such objectionable Content.
              </p>
              <p className="text-base leading-relaxed">
                ...
                or objectionable, and You agree that under no circumstances will the Company be liable
                in any way for any content, including any errors or omissions in any content, or any
                loss or damage of any kind incurred as a result of your use of any content.
              </p>

              <h3 className="text-2xl font-semibold mt-6 mb-3">Content Backups</h3>
              <p className="text-base leading-relaxed">
              ...
              <p className="text-base leading-relaxed">You agree to maintain a complete and accurate copy of any Content in a location independent of the
                Service.</p>


              <h2 className="text-3xl font-bold mt-8 mb-4">Copyright Policy</h2>

              <h3 className="text-2xl font-semibold mt-6 mb-3">Intellectual Property Infringement</h3>
              <p className="text-base leading-relaxed">
              ...
              <p className="text-base leading-relaxed">
                ...
                attention of our copyright agent via email at <a href="mailto:dmca@unsub.cash" className="text-primary hover:underline">dmca@unsub.cash</a> and
                include in Your notice a detailed description of the alleged infringement.
              </p>
              <p className="text-base leading-relaxed">You may be held accountable for damages (including costs and attorneys&apos; fees) for misrepresenting
                that
                any Content is infringing Your copyright.</p>

              <h3 className="text-2xl font-semibold mt-6 mb-3">DMCA Notice and DMCA Procedure for Copyright Infringement Claims</h3>
              <p className="text-base leading-relaxed">
              ...
              <ul className="list-disc pl-6 space-y-2 my-4">
                <li className="text-base leading-relaxed">An electronic or physical signature of the person authorized to act on behalf of the owner of the
                ...
                <li className="text-base leading-relaxed">Your address, telephone number, and email address.</li>
                <li className="text-base leading-relaxed">
              ...
              <p className="text-base leading-relaxed">
                You can contact our copyright agent via email at <a href="mailto:dmca@unsub.cash" className="text-primary hover:underline">dmca@unsub.cash</a>.
              ...
              <p className="text-base leading-relaxed">Upon termination, Your right to use the Service will cease immediately. If You wish to terminate Your
              ...
              <h2 className="text-3xl font-bold mt-8 mb-4">For European Union (EU) Users</h2>
              <p className="text-base leading-relaxed">
              ...
              <h2 className="text-3xl font-bold mt-8 mb-4">United States Legal Compliance</h2>
              <p className="text-base leading-relaxed">
              ...
              <h2 className="text-3xl font-bold mt-8 mb-4">Severability and Waiver</h2>

              <h3 className="text-2xl font-semibold mt-6 mb-3">Severability</h3>
              <p className="text-base leading-relaxed">
              ...
              <h3 className="text-2xl font-semibold mt-6 mb-3">Waiver</h3>
              <p className="text-base leading-relaxed">
              ...
              <h2 className="text-3xl font-bold mt-8 mb-4">Translation Interpretation</h2>
              <p className="text-base leading-relaxed">
              ...
              <p className="text-base leading-relaxed">If you have any questions about these Terms and Conditions, You can contact us:</p>
              <ul className="list-disc pl-6 space-y-2 my-4">
                <li className="text-base leading-relaxed">
                  By email:&nbsp;
                  <a href="mailto:terms@unsub.cash" className="text-primary hover:underline break-all">
                    terms@unsub.cash
                  </a>
                </li>
              </ul>
